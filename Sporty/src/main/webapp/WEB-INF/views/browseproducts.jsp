...
<body>
	...
	<c:forEach items="${shoes}" var="entry">
   	<tr>
   		<td><c:out value="${entry.sid}"></c:out></td>
		<td><c:out value="${entry.smodelname}"></c:out></td>
		<td><c:out value="${entry.scompany}"></c:out></td>
		<td><c:out value="${entry.scategory}"></c:out></td>
		<td><c:out value="${entry.sprice}"></c:out></td>
		<td><c:out value="${entry.simage}"></c:out></td>
		<td><c:out value="${entry.ssize}"></c:out></td>
   </tr>
		</c:forEach>
	</tbody>
</table>
