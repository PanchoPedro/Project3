...
<body>
	...
	<table >
	<caption>Current Users in the Database</caption>
	<thead>
	<tr>
		<th>ID</th>
		<th>Firstname</th>
	...
	<c:forEach items="${users}" var="entry">
   	<tr>
		...
		<td><c:out value="${entry.firstname}"></c:out></td>
		<td><c:out value="${entry.surname}"></c:out></td>
		<td><c:out value="${entry.email}"></c:out></td>
		<td><c:out value="${entry.phone}"></c:out></td>
		<td><c:out value="${entry.dateofbirth}"></c:out></td>
		<td><c:out value="${entry.type}"></c:out></td>
   </tr>
		</c:forEach>
	</tbody>
</table>
